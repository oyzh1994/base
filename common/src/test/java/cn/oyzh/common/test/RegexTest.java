...
//        }
    ...
    @Test
    public void test3() {
//        String yaml = "name: John  # 这是姓名注释\nage: 30 # 这是年龄注释\naddress:\n  city: New York # 这是城市注释\n  street: 123 Main St # 这是街道注释";
        String yaml = """
                # ==================================================================
                ...
                x-shared-env: &shared-api-worker-env
                  ...
                  EXPOSE_NGINX_PORT: ${EXPOSE_NGINX_PORT:-280}
                  EXPOSE_NGINX_SSL_PORT: ${EXPOSE_NGINX_SSL_PORT:-2443}
                ...
                services:
                  ...
                  nginx:
                    ...
                    depends_on:
                      ...
                      - web
                    ports:
                      - '${EXPOSE_NGINX_PORT:-280}:${NGINX_PORT:-80}'
                      - '${EXPOSE_NGINX_SSL_PORT:-2443}:${NGINX_SSL_PORT:-443}'
...
//        String regex = "^\\s*(#.*)|(\\s*)(([^:#\\s]+):\\s*(.*?)(?:\\s*#(.*))?)$";
        Pattern pattern = RegexHelper.yamlPattern();
        Matcher matcher = pattern.matcher(yaml);

        while (matcher.find()) {
            if (matcher.group(1) != null) {
                // 独立注释
                System.out.println("独立注释: " + matcher.group(1).trim().substring(1));
            } else {
                ...
                System.out.println("缩进: " + indent.length());
                System.out.println("键: " + key);
                System.out.println("值: " + (value != null ? value.trim() : ""));
                System.out.println("注释: " + (comment != null ? comment.trim() : "无"));
                System.out.println("-----------------");
            }
        }
    }
